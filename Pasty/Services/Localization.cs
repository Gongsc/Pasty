...
public static class Localization
{
    ...
    public static string Get(string key) => (IsEnglish, key) switch
    {
        ...
        (true, "EditContent") => "Edit content",
        (true, "ViewContent") => "View image",
        ...
        (true, "KindFile") => "File",
        (true, "OpenWindowHotkey") => "Open main window",
        (true, "PasteLatestHotkey") => "Paste latest",
        (true, "PressHotkey") => "Press shortcut…",
        (true, "HotkeyCaptureHint") => "Press the new shortcut, or press Esc to cancel.",
        (true, "HotkeyModifierRequired") => "Include Ctrl, Alt, or Win in the shortcut.",
        (true, "HotkeyDuplicate") => "The two shortcuts must be different.",
        ...
        (_, "KindFolder") => "文件夹",
        (_, "KindFile") => "文件",
        (_, "OpenWindowHotkey") => "打开主窗口",
        (_, "PasteLatestHotkey") => "粘贴第一条",
        (_, "PressHotkey") => "请按快捷键…",
        (_, "HotkeyCaptureHint") => "按下新的组合键，按 Esc 取消。",
        (_, "HotkeyModifierRequired") => "快捷键必须包含 Ctrl、Alt 或 Win。",
        (_, "HotkeyDuplicate") => "两项快捷键不能相同。",
